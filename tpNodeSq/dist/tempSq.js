...
function doCrudJobOnDeviseWithSequelize() {
    return __awaiter(this, void 0, void 0, function () {
        var sqDeviseService, deviseEur, deviseEurRelue, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sqDeviseService = new SqDeviseService_1.SqDeviseService();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, sqDeviseService.insert({ code: 'EUR', nom: 'euro', change: 0.92 })];
                case 2:
                    deviseEur = _a.sent();
                    console.log("after insert : deviseEur=" + JSON.stringify(deviseEur));
                    return [4 /*yield*/, sqDeviseService.findById("EUR")];
                case 3:
                    deviseEurRelue = _a.sent();
